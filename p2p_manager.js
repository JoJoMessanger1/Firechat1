 ...
 */
export async function createAnswer(partnerID, sdpOffer, onMessageCallback) {
    const pc = createConnection(partnerID, onMessageCallback);
 ...
 */
export async function handleSignalingCode(code, onMessageCallback) {
    ...
    if (type === 'OFFER') {
        await createAnswer(partnerID, sdpPayload, onMessageCallback);
